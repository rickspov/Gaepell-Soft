defmodule EvaaCrmWebGaepell do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: EvaaCrmWebGaepell.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {EvaaCrmWebGaepell.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: EvaaCrmWebGaepell.Endpoint,
        router: EvaaCrmWebGaepell.Router,
        statics: EvaaCrmWebGaepell.static_paths()
    end
  end
